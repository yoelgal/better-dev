...
- A source archive for the target repo - discovered, or created and recorded in the harness's durable
  memory on first use; never assumed from a prior harvest's target.
