...
export class BrowserManager {
  ...
  async launchHeaded(authToken?: string): Promise<void> {
    ...
    // ponytail: upstream's macOS Info.plist rebrand ("GStack Browser" name +
    // Dock icon) and the stock-Chrome UA spoof were removed in the better-dev
    // vendored cut (branded-browser + stealth glue; see browse/UPSTREAM).
    const customUA: string | undefined = undefined;
