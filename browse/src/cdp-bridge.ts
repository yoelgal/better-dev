...
// ponytail: upstream telemetry removed in the better-dev vendored cut.
// Denials still surface via the thrown DENIED error below.
const logTelemetry = (_event: Record<string, unknown>): void => {};
