...
describe('sanitizeLoneSurrogates — wiring invariants', () => {
  ...
  // SSE wiring-invariant tests removed with the better-dev vendored cut:
  // the SSE endpoints (activity stream, inspector events) were extension
  // glue and are not vendored; createSseEndpoint is gone with them.
